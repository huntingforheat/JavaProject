 ...
 * Generated at: 2024-04-17 08:36:46 UTC
...
public final class board_005fmodify_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(session.getAttribute("user_id") == null) { 
      ...
      out.write("			<form name = \"regform\" action = \"update.board?pageNum=");
      ...
      out.write("				<h2>게시판 글 수정 페이지</h2>\n");
      out.write("				<hr>\n");
      out.write("				<table border = \"1\" style = \"widht : 500px\">\n");
      out.write("					<tr>\n");
      ...
      out.write("    		// 작성자, 글 제목에 공백확인, 공백이 아니라면 submit() 처리\n");
      out.write("    		if(document.regform.title.value == '') {\n");
      out.write("    			alert(\"제목 입력은 필수 사항입니다.\");\n");
      out.write("    			return;\n");
      out.write("    		} else if(document.regform.content.value.length >= 2000) {\n");
      out.write("    			alert(\"2000글자 미만으로 작성 해주세요\");\n");
      out.write("    			return;\n");
      out.write("    		} else if(document.regform.writer.value.length >= 50) {\n");
      out.write("    			alert(\"50글자 미만으로 작성 해주세요\");\n");
      out.write("    			return;\n");
      out.write("    		} else if(document.regform.title.value.length >= 50) {\n");
      out.write("    			alert(\"50글자 미만으로 작성 해주세요\");\n");
      out.write("    			return;\n");
      out.write("    		} else if(confirm(\"수정을 완료하시겠습니까?\")) {\n");
